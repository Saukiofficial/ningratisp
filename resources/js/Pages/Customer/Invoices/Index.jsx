    ...
    return (
        <AuthenticatedLayout>
            ...
            <style>{`
                ...
                .inv-alert.warning { background: rgba(255,140,0,0.08); border-color: rgba(255,140,0,0.3); border-left: 4px solid #ff8c00; }
                .inv-alert.success { background: rgba(16,185,129,0.08); border-color: rgba(16,185,129,0.3); border-left: 4px solid #10b981; }
                .inv-alert.info    { background: rgba(59,130,246,0.08); border-color: rgba(59,130,246,0.3); border-left: 4px solid #3b82f6; }
                .inv-alert-icon {
                ...
                .inv-alert-text { font-size: 0.85rem; font-weight: 600; }
                ...
                .inv-filter-header { display: flex; align-items: center; justify-content: space-between; }
                .inv-filter-title {
                    display: flex; align-items: center; gap: 8px;
                    font-size: 0.82rem; font-weight: 700;
                    letter-spacing: 0.08em; text-transform: uppercase; color: #ff8c00;
                }
                .inv-filter-toggle {
                ...
                .inv-field-input {
                    ...
                    border-radius: 10px; padding: 9px 12px; font-size: 0.83rem; font-weight: 500;
                    color: rgba(255,255,255,0.8); font-family: 'Plus Jakarta Sans', sans-serif;
                ...
                .inv-filter-btn {
                    ...
                    padding: 9px 22px; background: linear-gradient(135deg, #ff8c00, #ff6a00);
                    color: white; font-weight: 700; font-size: 0.82rem; border-radius: 10px;
                ...
                .inv-filter-btn:hover { box-shadow: 0 6px 20px rgba(255,110,0,0.5); transform: translateY(-1px); }

                /* ── Section header ── */
                .inv-section-header { display: flex; align-items: center; margin-bottom: 14px; }
                .inv-section-title {
                ...
                .inv-table thead tr { border-bottom: 1px solid rgba(255,255,255,0.06); }
                .inv-table th {
                ...
                .inv-table tbody tr:hover { background: rgba(255,140,0,0.04); }
                .inv-table td { padding: 16px 20px; font-size: 0.85rem; color: rgba(255,255,255,0.7); vertical-align: middle; }
                .inv-table td.date { font-weight: 600; color: rgba(255,255,255,0.85); }
                .inv-table td.amount { font-family: 'Sora', sans-serif; font-weight: 700; color: #ffffff; }
                ...
                .inv-voucher {
                    ...
                    color: #34d399; font-size: 0.68rem; font-weight: 700; letter-spacing: 0.03em;
                }
                ...
                .inv-badge.paid   { background: rgba(16,185,129,0.12); color: #34d399; border: 1px solid rgba(16,185,129,0.25); }
                .inv-badge.unpaid { background: rgba(239,68,68,0.12);  color: #f87171; border: 1px solid rgba(239,68,68,0.25); }
                ...
                .inv-view-btn {
                    ...
                    color: #ff8c00; font-size: 0.78rem; font-weight: 700;
                    text-decoration: none; transition: all 0.2s; white-space: nowrap;
                }
                .inv-view-btn:hover { background: rgba(255,140,0,0.18); border-color: rgba(255,140,0,0.4); color: #ffaa33; }

                /* ── Mobile cards ── */
                .inv-mobile-list { display: flex; flex-direction: column; gap: 12px; }
                ...
                .inv-mobile-card:hover { border-color: rgba(255,140,0,0.25); }
                .inv-mobile-card-top {
                ...
                .inv-mobile-card-footer {
                    display: flex; align-items: center; justify-content: flex-end;
                    padding-top: 12px; border-top: 1px solid rgba(255,255,255,0.05);
                }
                .inv-mobile-arrow {
                    display: flex; align-items: center; gap: 5px;
                    font-size: 0.75rem; font-weight: 600; color: rgba(255,140,0,0.7);
                }
                ...
                .inv-empty-icon {
                    ...
                    margin: 0 auto 14px; color: rgba(255,255,255,0.2);
                }
                .inv-empty-text { font-size: 0.9rem; font-weight: 600; color: rgba(255,255,255,0.25); }
                ...
                .inv-page-btn {
                    ...
                    border: 1px solid rgba(255,255,255,0.08); color: rgba(255,255,255,0.5); background: #1a1a1a;
                }
                .inv-page-btn:hover { color: #ff8c00; border-color: rgba(255,140,0,0.3); }
                .inv-page-btn.active {
                    background: linear-gradient(135deg, #ff8c00, #ff6a00); color: white;
                    border-color: transparent; box-shadow: 0 4px 12px rgba(255,110,0,0.35);
                }
                ...
                <div className="inv-container">
                    ...
                    <div className="inv-filter-card">
                        <div className="inv-filter-header">
                            ...
                            <button className="inv-filter-toggle" style={{ display: 'none' }}
                                id="filter-toggle-btn"
                                onClick={() => setIsFilterOpen(!isFilterOpen)}>
                                {isFilterOpen ? 'Tutup' : 'Buka'} <ChevronIcon open={isFilterOpen} />
                            </button>
                            <style>{`.sm-hidden-flex { display: flex !important; } @media (min-width: 640px) { .sm-hidden-flex { display: none !important; } }`}</style>
                                ...
                                <tbody>
                                    {tagihans.data.map((tagihan) => (
                                        <tr key={tagihan.id} onClick={() => router.visit(route('customer.invoices.show', tagihan.id))}>
                                            <td className="date">
                                                <div style={{ display: 'flex', alignItems: 'center', gap: 5, color: 'rgba(255,255,255,0.35)', fontSize: '0.7rem', marginBottom: 3 }}>
